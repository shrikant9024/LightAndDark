    ...
    <div className={`${darkMode && "dark"}`}>
      <main className="flex min-h-screen flex-col p-12 bg-neutral-100 dark:bg-neutral-900 ">
        <nav className="grid grid-cols-3 items-center">
          ...
          <span className="justify-self-center text-gray-600 font-mono">
            September 2023 | San Francisco, CA
          </span>
          <button className="justify-self-end p-4 bg-slate-700 text-white rounded-xl font-semibold">
            Get your tickets
          </button>
        </nav>
        <section className="w-[90%] max-w-3xl mx-auto mt-40 flex flex-col gap-8">
          <h1 className="text-gray-600 dark:text-gray-300 text-7xl font-semibold">
            A design conference for the dark side.
          </h1>
          <p className="text-sky-800  dark:text-gray-300 text-2xl tracking-wide leading-relaxed">
